...
**Table 1. Model prediction table. Rows are predictors and columns are models.**
...
**Results:**\
**We found that water treatments and species significantly predicted total biomass, but not SLA (Table 1). Across species and SLA on average, plants in well watered treatment are 0.12 ± 0.017 g greater than plants in drought stressed treatment. Across water treatments and SLA on average, Eschscholzia californica plants were -0.23 ± 0.032 g less than Acmispon glaber (F(7, 62) = 27.08, p < 0.001, ⍺ = 0.05, adjusted R2 = 0.73).**
...
![](images/Mann–Whitney_Wilcoxon_Rank-Sum_tests.png){width="406"}
