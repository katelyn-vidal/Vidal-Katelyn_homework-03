...
# turning everything into a flextable
  ...
  # adding caption
  set_caption(caption = as_paragraph(colorize("Table 1. Rows are models and columns show the intercept, predictors (water treatment and species), AIC, and ∆AIC", color = "black"))) %>% 
...
ggplot() +
  ...
  geom_pointrange(data = model_preds_for_plotting,
              ...
              alpha = 0.9,
              size = 0.3) +
  # change color of model prediction 95% CI and underlying data
