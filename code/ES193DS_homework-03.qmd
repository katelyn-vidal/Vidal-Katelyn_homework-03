...
**Results:**\
**We found that water treatments and species significantly predicted total biomass, but not SLA (Table 1). Across species and SLA on average, plants in well watered treatment are 0.12 ± 0.019 g greater than plants in drought stressed treatment. Across water treatments and SLA on average, Lotus scoparius plants were -0.23 ± 0.032 g less than Encelia californica. F(7, 62) = 27.08, p < 0.001, ⍺ = 0.05, adjusted R2 = 0.73**
