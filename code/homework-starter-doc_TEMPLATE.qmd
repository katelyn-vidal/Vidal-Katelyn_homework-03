...
**Shoot mass is strongly positively correlated with total mass (Pearson's r = 0.902)**  

**Root mass is strongly positively correlated with total mass (Pearson's r = 0.858)**
...
**Gumweed, California poppy, and purple needle grass seem to have the highest biomass; Deerweed, Scarlet bugler, and purple sage seem to have the lowest biomass.**
...
**Total biomass in well watered water treatments seem to be higher.**
...
**As sla increases total biomass seems to increase. Moderate ot strong correlation depending on how you round.**
...
model.sel(model0,
          ...
          model3)
```
**Delta AIC for the best model is always 0**
...
**Double check the dignostics for the best model**
...
- intercept: **mass of the reference (Acmison glaber) in drought stressed water treatment when SLA = 0 **  
- SLA slope: **For each 1 unit increase in SLA (mm^2/g), you expect a decrease in plant mass of 0.0002 ± 0.0005, SO NO EFFECT OF SLA ON MASS.*  
